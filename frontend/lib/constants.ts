...
export const EXPERT_NAV_LINKS = [
  ...
  { href: "/expert/sessions", label: "Sessions", icon: "CalendarCheck" },
...
export const INSTITUTION_NAV_LINKS = [
  ...
  { href: "/institution/entrepreneurs", label: "Entrepreneures", icon: "Users" },
  ...
  { href: "/institution/reports", label: "Rapports", icon: "FileBarChart" },
