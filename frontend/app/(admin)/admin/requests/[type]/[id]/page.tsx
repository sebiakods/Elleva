...
export default function RequestDetailsPage() {
  ...
  async function handleDecision(
    ...
    try {
      ...
      const res = await fetch(
        `${API_URL}/account-requests/${id}/${decision}`,
        {
          method: "PATCH",
          headers: token
            ? {
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border bg-white p-6">
          ...
          {application.type === "EXPERT" ? (
            ...
            <div className="space-y-3">
              ...
              <p>
                <b>Titre :</b> {application.title || "—"}
              </p>

              <p>
                <b>Expérience :</b> {application.experience || "—"}
              </p>

              <p>
                <b>Domaines :</b> {application.specialties || "—"}
              </p>

              <p>
                <b>Langues :</b> {application.languages || "—"}
              </p>
            ...
            <div className="space-y-3">
              ...
              <p>
                <b>Institution :</b> {application.organizationName || "—"}
              </p>

              <p>
                <b>Type :</b> {application.organizationType || "—"}
              </p>

              <p>
                <b>Wilaya :</b> {application.wilaya || "—"}
              </p>

              <p>
                <b>Secteurs :</b> {application.sectors || "—"}
              </p>
        ...
        {application.cvPath && (
          ...
          <div className="rounded-2xl border bg-white p-6">
            ...
            <a
              href={`${API_URL.replace("/api","")}/${application.cvPath}`}
              target="_blank"
              className="flex gap-2 text-rose-600"
            >
              <FileText size={20}/>
        ...
        <div className="rounded-2xl border bg-white p-6">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="rounded-xl bg-rose-500 px-5 py-3 text-white"
            >
