...
export default function EditInstitutionProgramPage() {
  ...
  const loadProgram = useCallback(async () => {
    ...
    try {
      ...
      console.log("Loading program:", url);
      ...
      // }
      //
      const program: Program | undefined = json?.data;
      ...
      setCategory(
        program.category &&
          CATEGORIES.some(
            (item) => item.value === program.category
          )
          ? program.category
          : "BANK_LOAN"
      );
  ...
  async function handleSubmit(
    ...
    if (
      ...
      setError(
        "Minimum amount can't be greater than maximum amount."
      );
      return;
    }
    ...
    return (
      <div className="mx-auto max-w-4xl p-6">
        <Link
          ...
          className="font-body inline-flex items-center text-sm font-medium text-ink-soft transition hover:text-rose-500"
        >
          ← Back to Programs
        </Link>
    ...
    <div className="mx-auto max-w-4xl p-6">
      ...
      <div className="mb-8 mt-4">
        ...
        <p className="font-body mt-2 text-ink-soft">
          Update the details below. Changes are
