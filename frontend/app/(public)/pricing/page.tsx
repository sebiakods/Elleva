...
const plans = [
  {
    ...
    price: "0 DA",
    period: "toujours",
    features: ["Accès à l'annuaire de financement", "business plan", "Calculateurs de base","Meetings", "FAQ"],
  ...
  },
  {
    ...
    price: "1 900 DA",
    period: "/  Full Course",
    features: ["accès complet à la formation Elle s'élève","Business plans illimités", "Export PDF avancé", "Accès mentorat prioritaire", "Support dédié"],
    cta: "Choisir Premium",
    highlighted: true,
  },
  {
