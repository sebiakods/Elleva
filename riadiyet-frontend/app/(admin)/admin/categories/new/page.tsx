      ...
      >
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.image}
                    onChange={handleChange}
                    placeholder="/images/categories/startup.jpg"
                    className="w-full rounded-xl border p-3"
                  />
          ...
          <aside className="space-y-6">
              ...
              <div className="overflow-hidden rounded-2xl border bg-white">
                ...
                <div className="p-5">
                  ...
                  <p className="line-clamp-4 text-sm leading-6 text-ink-soft">
                    {form.description ||
                      "La description de votre catégorie apparaîtra ici lorsque vous commencerez à la rédiger."}
                  </p>
            ...
            <section className="card-surface rounded-2xl p-6 shadow-card">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-ink-soft">Couleur</span>
                ...
                <div className="flex justify-between">
                  <span className="text-ink-soft">Icône</span>

                  <span>{form.icon || "--"}</span>
                </div>

                <div className="flex justify-between">
                  <span className="text-ink-soft">SEO</span>
        ...
        <div className="card-surface flex flex-col gap-4 rounded-2xl p-6 shadow-card md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-sm text-ink-soft">
              Vérifiez les informations avant d'enregistrer cette catégorie.
            </p>
          </div>
